      ...
      <div className='border bg-background w-[285px] rounded-md'>
        <div className='flex items-center justify-between px-2 h-10'>
          <div className='flex items-center gap-2'>
            <Table2 className='size-4 text-muted-foreground flex-shrink-0' />
            <h1 className='text-sm w-[200px] truncate'>{data?.tableName}</h1>
          </div>
          <Link href={`/dashboard/${id}/${schema}/${data?.tableName}`}>
