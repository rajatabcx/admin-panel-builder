...
export const features: Feature[] = [
  ...
  },
  {
    ...
    description:
      'Visualize your database architecture, connections and more in an interactive diagram.',
...
export const steps: Step[] = [
  ...
  },
  {
    ...
    description:
      'Add your database connection string to get started. We only support PostgreSQL at the moment.',
    icon: Zap,
    image: '/how-it-works/create.png',
  },
  {
    title: '3. Manage your Database',
    description: "That's it! enough chit-chat, Explore your database.",
    icon: LineChart,
...
export const problems = [
  ...
  },
  {
    ...
    description:
      'Traditional database management solutions are expensive and they have a learning curve.',
